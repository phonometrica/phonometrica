#!/usr/bin/env python3
#
# Phonometrica documentation build configuration file, created by
...
# The above option doesn't work, somehow, but the following one does.
