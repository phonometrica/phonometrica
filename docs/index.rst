...
-  Windows 7 and later:
   `setup\_phonometrica.exe <https://github.com/phonometrica/phonometrica/releases/download/v0.7.1/setup_phonometrica.exe>`__
-  MacOS 10.12 and later:
   `phonometrica-0.7.1.dmg <https://github.com/phonometrica/phonometrica/releases/download/v0.7.1/phonometrica-0.7.1.dmg>`__
-  Linux (Debian 10): `phonometrica-0.7.1.deb <https://github.com/phonometrica/phonometrica/releases/download/v0.7.1/phonometrica-0.7.1.deb>`__
-  source code: `phonometrica-0.7.1.zip <https://github.com/phonometrica/phonometrica/archive/v0.7.1.zip>`__ | `phonometrica-0.7.1.tar.gz <https://github.com/phonometrica/phonometrica/archive/v0.7.1.tar.gz>`__
...
Phonometrica's documentation is available as a `PDF <https://github.com/phonometrica/phonometrica/releases/download/v0.7.1/phonometrica_manual.pdf>`_ file.
