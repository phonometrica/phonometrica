...
public:
	...
	Version(const wxDateTime &date, const String &description, const String &number = String());

	wxDateTime date() const;
	String date_as_string() const;
	static wxDateTime parse_date(const String &date);
	void set_date(const wxDateTime &date);
